...
func (in *Moodle) DeepCopyInto(out *Moodle) {
	*out = *in
...
func (in *Moodle) DeepCopy() *Moodle {
	if in == nil {
		return nil
	}
	out := new(Moodle)
...
func (in *Moodle) DeepCopyObject() runtime.Object {
